...
<div class="container-fluid">
	...
	<div class="contentheader">
			<center><i class="icon-bar-chart"></i> Sales Report</div></center>
			<ul class="breadcrumb">
	...
	<thead>
		<tr>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $db->prepare("SELECT sum(grandtotal) FROM sales WHERE date BETWEEN :a AND :b");
				$results->bindParam(':a', $d1);
				$results->bindParam(':b', $d2);
				$results->execute();
				for($i=0; $rows = $results->fetch(); $i++){
				$dsdsd=$rows['sum(grandtotal)'];
				echo formatMoney($dsdsd, true);
				}
				?>
			</th>
