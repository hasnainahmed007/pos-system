...
<span>Food Code : </span><input type="text" style="width:265px; height:30px;"  name="code" value="<?php echo $row['product_code']; ?>" Required/><br>
<span>Food Name : </span><textarea style="width:265px; height:50px;" name="name" ><?php echo $row['product_name']; ?> </textarea><br>
...
<!--span>Vat : </span><input type="text" id="txt" style="width:265px; height:30px;" name="vat" onkeyup="sum();" Required><br-->
