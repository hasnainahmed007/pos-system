...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="sidebar-nav">
			...
			<li class="active"><a href="sales_inventory.php"><i class="icon-table icon-2x"></i>Sales Invoice</a>                </li>
			<br><br><br><br><br><br>		
			<li>
...
<button  style="float:right;" class="btn btn-success btn-large"><a href="javascript:Clickheretoprint()"> Print</button>
<div class="content" id="content">
<br><br><br>
<center><strong>Sales Invoice</strong></center>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="12%"> Invoice </th>
			<th width="9%"> Date </th>
			<th width="14%"> Food Code </th>
			<th width="15%"> Customer Name </th>
			<th > Price </th>
			<th> QTY </th>

			<th width="8%"> Total Amount(with vat & food item) </th>
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$result = $db->prepare("SELECT * FROM sales_order as o,sales as s WHERE o.invoice=s.invoice_number ORDER BY s.date DESC");
				$result->execute();
			...
			<tr>
				...
				<?php
				$resultas = $db->prepare("SELECT sum(grandtotal) from sales");
				$resultas->bindParam(':a', $sdsd);
				$resultas->execute();
				for($i=0; $rowas = $resultas->fetch(); $i++){
				$fgfg=$rowas['sum(grandtotal)'];
