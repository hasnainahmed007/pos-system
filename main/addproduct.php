...
<center><h4><i class="icon-plus-sign icon-large"></i> Add Foods</h4></center>
<hr>
<div id="ac">
<span>Food Code : </span><input type="text" style="width:265px; height:30px;" name="code" ><br>
<span>Food Name : </span><textarea style="width:265px; height:50px;" name="name"> </textarea><br>
